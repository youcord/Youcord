...
const latestReleaseInformation = await fetch("https://api.github.com/repos/nightcordlegit/youcord/releases/latest", {
    headers: {
...
const metaInfo = await fs.readFile("./meta/app.youcord.Youcord.metainfo.xml", "utf-8");
...
await fs.writeFile("./meta/app.youcord.Youcord.metainfo.xml", output, "utf-8");
